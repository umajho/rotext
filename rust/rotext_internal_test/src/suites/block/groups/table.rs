            ...
            cases: vec![
                ...
                case!(
                    ...
                    vec![
                        ...
                        (EventType::IndicateTableDataCell, None),
                        (EventType::EnterParagraph, None),
                        (EventType::__Unparsed, Some("line 1")),
                        (EventType::NewLine, None),
                        (EventType::__Unparsed, Some("line 2")),
                        (EventType::ExitBlock, None),
                        (EventType::ExitBlock, None),
                    ]
                ),
            ...
            cases: vec![
                case!(
                    ...
                    vec![
                        ...
                        (EventType::EnterParagraph, None),
                        (EventType::__Unparsed, Some("CAPTION")),
                        (EventType::ExitBlock, None),
                        (EventType::ExitBlock, None),
                    ]
                ),
                ...
                case!(
                    ...
                    vec![
                        ...
                        (EventType::IndicateTableDataCell, None),
                        (EventType::EnterParagraph, None),
                        (EventType::__Unparsed, Some("|+ NOT CAPTION")),
                        (EventType::ExitBlock, None),
                        (EventType::ExitBlock, None),
                    ]
                ),
